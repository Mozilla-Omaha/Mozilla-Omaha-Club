...
/* ******************** Start: Mozilla Omaha Library Extensions. ******************** */





/* *** Notes: base lifecycle object *** */
...
{
  created: {
    preload: function( preloadOptions ){
return "Welcome to the baseLifecyle object.";
    }
  },
  inserted: {
    onstart: function(){
...
var x_application = xtag.register( "x-aside", 
    {
    lifecycle: 
      {
        created: function(){

  lifecycle.created.preload();
