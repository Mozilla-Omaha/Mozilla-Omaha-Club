(function () {
/* ********************
	Notes: Core JS extension written by Kip of Omaha (Steve Van Sant), on behalf of the Mozilla Omaha Club and the Mozilla
	Foundation. 
	...
	1. String.prototype._toJSON [~~L:23]

******************** */


/* ********************
	Notes: String Prototype to convert strings to JSON
	has_JSON_Format: true/false, tells the instructions that the string already is JSON formatted.

******************** */


	String.prototype._toJSON = function(has_JSON_Format){
